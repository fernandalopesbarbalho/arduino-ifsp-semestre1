...
if (T <= 24){
  digitalWrite(LedPin, HIGH); //acende luz caso temperatura seja menor ou igual a 24
}else{
  digitalWrite(LedPin, LOW); //desliga luz
}

//a porta GND e A0 estão trocadas para que a temperatura varie na simulação

delay(1500); //visibilidade da temperatura e do led
}